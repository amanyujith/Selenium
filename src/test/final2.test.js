...
describe("ncs-app", async function () {
  ...
  it("should reset password with a valid email ", async function () {
    ...
    it("NCS App Test-Login Case", async function () {
      ...
      await driver
        ...
        .sendKeys("sidharth.sl@netstratum.com");
  ...
  //chat 
    ...
    //     await driverB
    //       .findElement(By.id("b7547bd9-1d86-4ff8-a201-dd5dd325ff74"))
    //       .click();
    ...
    it("cancelMeeting in the scheduled Meeting Session ", async function() {
  ...
  it('scheduledMeeting in Meeting Session', async function() {
    // await driver.get("http://localhost:3000/app/home");
    try{
    const meeting =  await driver.wait(until.elementLocated(By.id("MEETINGSECTION")));
    await meeting.click();
...
it("new-upcoming-meeting in Meeting Session", async function () {
    try{
...
describe("Start Meeting",async function () {
  ...
  it("Clearing status",async function () {
    await driver.findElement(By.id('clear-status')).click();
  await driver.sleep(2000);
  })
