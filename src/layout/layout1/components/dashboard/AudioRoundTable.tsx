...
const AudioRoundTable = () => {
    ...
    return (
        <div className='w-[calc(100vw-312px)] mt-5 ml-5 text-left'>
            <div className=' text-xl font-bold mb-8 text-primary-200'>Audio Round Table</div>
            <div className='pl-[7px]'>
                ...
                <CheckBox color={''} label={'Recurring meeting'} id={'recurringMeeting'} restClass={'ml-[196px] mt-5'} />
                <div className='flex mt-5'>
                    ...
                    <RadioButton
                        radioData={[
                            { id: 'option1', label: 'Generate Automatically', value: 'Auto' }
                            , { id: 'option2', label: 'Personal Meeting ID 587982652', value: 'personal' }
                        ]}
                        name={'meetingID'}
                        restClass={'mr-10'}
                    />
...
export default AudioRoundTable